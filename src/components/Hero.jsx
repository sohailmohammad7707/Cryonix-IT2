        ...
        <div className="flex min-h-[80vh] items-center px-8 pt-46 ml-4">
          ...
          >
            ...
            <motion.div variants={item}>
              <p className="mb-4 font-merriweather text-xl leading-relaxed text-[#303030]">
                We build high-performance web applications, cloud solutions, and
                AI-powered products that help businesses grow faster.
              </p>

              <p className="font-merriweather text-xl leading-relaxed text-[#303030]">
            ...
            <motion.div variants={item} className="mt-2 flex gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="group flex items-center gap-2 rounded-full bg-[#0f172b] px-10 py-3 text-xl text-white shadow-lg"
              >
                <Rocket
                  size={22}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="rounded-full border-2 border-[#0f172b] px-10 py-3 text-xl text-[#121212] transition-all duration-300 hover:bg-[#0f172b] hover:text-white"
              >
                View Portfolio
              </motion.button>
            </motion.div>
